...
export default function VSLBlackRock() {
  useEffect(() => {
    const loadPlayerScript = () => {
      if (document.querySelector('script[src*="6925dfb27ac26831094ad1ba"]')) return;
      const script = document.createElement("script");
      script.src = "https://scripts.converteai.net/7811ed69-550c-4b89-9a28-8ab5dbe8db56/players/6925dfb27ac26831094ad1ba/v4/player.js";
      script.async = true;
      script.onload = () => {
  ...
  return (
    ...
    <vturb-smartplayer
      id="vid-6925dfb27ac26831094ad1ba"
      style={{
        display: "block",
        margin: "0 auto",
        width: "100%",
